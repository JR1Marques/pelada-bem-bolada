        ...
        <>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="titulo" className="block text-sm font-medium text-gray-700 mb-1">Título da Pelada</label>
                <input
                  id="titulo"
                  type="text"
                  required
              ...
              <div>
                <label htmlFor="dataHora" className="block text-sm font-medium text-gray-700 mb-1">Data e Hora</label>
                <input
                  id="dataHora"
                  type="datetime-local"
                  required
              ...
              <div>
                <label htmlFor="valor" className="block text-sm font-medium text-gray-700 mb-1">Valor por Jogador (R$)</label>
                <input
                  id="valor"
                  type="number"
                  step="0.01"
